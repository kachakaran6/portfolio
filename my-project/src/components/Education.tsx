...
export function Education() {
  ...
  return (
    <section id="education" className="w-full px-4 md:px-margin-desktop py-24 border-b border-grid-line bg-background relative" ref={containerRef}>
            ...
            <div key={index} style={{ opacity: 0 }} className="relative group">
              ...
              <div className="bg-paper-white border border-grid-line p-6 md:p-8 transition-shadow duration-300 hover:shadow-[4px_4px_0px_var(--color-secondary)] hover:border-secondary relative">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
                  ...
                  <span className="font-label-mono-bold text-sm text-secondary bg-surface-dim px-3 py-1 whitespace-nowrap">
                    {item.year}
                  </span>
                </div>
